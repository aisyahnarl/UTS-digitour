    ...
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <main class="flex-1 p-6 md:p-12 overflow-y-auto">
            ...
            <div class="relative bg-indigo-900 h-[400px] rounded-[50px] overflow-hidden shadow-2xl shadow-indigo-200 group">
                <img src="https://images.unsplash.com/photo-1596402184320-417d7178b2cd?auto=format&fit=crop&q=80&w=1200" class="absolute inset-0 w-full h-full object-cover opacity-60 group-hover:scale-105 transition-transform duration-700">
                ...
                <div class="absolute bottom-12 left-12 right-12">
                    ...
                    <p class="text-indigo-100 max-w-xl text-lg opacity-80 mb-8">Dengarkan narasi eksklusif tentang simbolisme tersembunyi di lantai ketiga candi terbesar di dunia.</p>
